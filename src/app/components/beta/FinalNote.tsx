      ...
      <div className="container py-14 md:py-20 text-brandDark">
        <div className="max-w-3xl mx-auto space-y-6">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-2xl md:text-3xl font-serif text-brandSecondary font-semibold">A final note</h2>
          </div>
          ...
          <p className="text-md md:text-lg leading-relaxed">Ruchika</p>
        </div>
      </div>
    </section>
  );
