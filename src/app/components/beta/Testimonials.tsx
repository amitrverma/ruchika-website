    ...
    <section id="testimonials" className="bg-white">
      <div className="container py-14 md:py-20 text-brandDark">
        <div className="max-w-3xl mx-auto space-y-8">
          <h2 className="text-xl md:text-2xl font-serif text-brandSecondary font-semibold"> 
            ...
            <div className="border border-brandDark/40">
              <div className="grid md:grid-cols-[160px_1fr]">
                ...
                <div className="p-5 space-y-3">
                  <p className="text-md font-semibold text-brandSecondary">
                    For Website messaging and copywriting project
                  </p>
                  <blockquote className="text-md md:text-lg leading-relaxed italic">
                  ...
                  <p className="text-md md:text-base">Founder, Tanishqjha.co - OBM and VA</p>
                </div>
              </div>
            </div>
            ...
            <div className="border border-brandDark/40">
              <div className="grid md:grid-cols-[160px_1fr]">
                ...
                <div className="p-5 space-y-3">
                  ...
                  <p className="text-md md:text-base">Green Trinkets</p>
                </div>
              </div>
            </div>
            ...
            <div className="border border-brandDark/40">
              <div className="grid md:grid-cols-[160px_1fr]">
                ...
                <div className="p-5 space-y-3">
                  ...
                  <p className="text-md md:text-base">Founder, Xaltris Technologies</p>
                </div>
              </div>
            </div>
          </div>
