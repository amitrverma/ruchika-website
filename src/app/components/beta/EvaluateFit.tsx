      ...
      <div className="container py-14 md:py-20 text-brandDark">
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <ul className="list-disc pl-5 space-y-3 text-md md:text-lg leading-relaxed">
            ...
            <li>
              You want a website that serves as your main marketing asset, <span className="text-brandSecondary">a
              single place you can confidently share with everyone.</span>
            </li>
            <li>
              Your <span className="text-brandSecondary">current website feels unclear and lacks cohesion </span>after
              multiple updates made at different stages of your business.
            </li>
            <li>
              You are operating fully in a founder role and <span className="text-brandSecondary">want a trusted
              partner to take ownership of your website strategy and copy. </span>
            </li>
            <li>
              You know your business needs a website, but you have not
              prioritized it yet <span className="text-brandSecondary">because it is hard to know where to start.</span>
            </li>
          </ul>
          ...
          <ul className="list-disc pl-5 space-y-3 text-md md:text-lg leading-relaxed">
            ...
            <li>
              Clear website structure with user experience in mind, <span className="text-brandSecondary">so visitors
              know where to go next when they land on your site.</span>
            </li>
            <li>Copy that helps visitors <span className="text-brandSecondary">evaluate fit and take the next step.</span></li>
            <li>
              Fewer misaligned inquiries, leading to <span className="text-brandSecondary">more relevant conversations
              with best-fit clients.</span>
            </li>
          ...
          <ul className="list-disc pl-5 space-y-3 text-md md:text-lg leading-relaxed">
            ...
            <li>
              You <span className="text-brandSecondary">clearly understand your best-fit clients </span>and who you want your
              website to attract.
            </li>
