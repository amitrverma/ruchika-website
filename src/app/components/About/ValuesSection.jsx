...
export default function ValuesSection() {
  const values = [
    {
      icon: <Leaf className="w-8 h-8 text-brand-accent" />,
      title: "Flexibility",
    ...
    {
      icon: <Handshake className="w-8 h-8 text-brand-accent" />,
      title: "Collaboration",
        ...
        <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-3">
          {values.map((value, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="flex flex-col items-center text-center bg-white rounded-2xl shadow-sm hover:shadow-md p-8 border border-brand-accent/20 transition-all"
            >
