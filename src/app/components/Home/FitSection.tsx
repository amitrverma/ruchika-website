  ...
  return (
    <section className="bg-brandPrimary py-14 md:py-20">
      ...
      <div className="container relative z-10 max-w-4xl text-brandSecondary">
        ...
        >
          I’m the <span className="text-brandSecondary">messaging-first copywriter</span> for you if…
        </motion.h2>
        ...
        <div className="grid gap-8">
          {points.map((point, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="flex items-start gap-4 bg-white/80 backdrop-blur-md border border-brandSecondary/20 rounded-xl shadow-sm hover:shadow-md transition-all p-6"
            >
              <div className="flex-shrink-0 mt-1">
                <CheckCircle2 className="w-8 h-8 text-brandSecondary" />
              </div>
              <p className="text-brandDark leading-relaxed">{point}</p>
            </motion.div>
          ))}
        </div>
